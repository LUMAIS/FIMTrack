...
//                    edgesOrig += maskGcProbFg;  // 9.6.ProbFgRoiMask
                    ...
                    maskTmp -= maskClaheBg;
                    if(DEV_MODE >= 4 && extraVis)
                        showCvWnd("9.6.0.4.ErdMaskClaheFg", maskTmp, cvWnds);
                    edgesOrig -= maskTmp;
                    ...
                    //    showCvWnd("9.6.0.8.CntRfnEdgesOrigRoi", maskHullClaheAth, cvWnds);
                    //}
